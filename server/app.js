...
app.get('/musicians', async (req, res, next) => {
    ...
    // Your code here
    const { firstName, lastName, bandName, instrumentTypes, musicianFields } = req.query;
    ...
    */
    ...
    // Your code here
    // Not sure about this. Don't specify, don't include, only include -
    // Do nothing, only id, only specified?
